...
$steps = array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'select',
				'selectedvalue' => (isset($_SESSION['params']['db_skip_install']) ? ($_SESSION['params']['db_skip_install'] == 'true' ? 'true' : 'false') : 'false'),
				'items' => array(
					'false' => 'False',
					'true' => 'True'
				),
	...
	array(
		...
		'callbacks' => array(
			array(
				'name' => 'install', // run "install" function the "includes/callbacks.php" file upon successful form submission
				'execute' => 'after'
			),
		),
	),
